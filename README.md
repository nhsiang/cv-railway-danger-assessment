...
- ### YOLO semantic segmentation for rail curvature calculation
  ...
  - The final curvature used to determine the message on screen is $κ(y)_{\text{median}}$, if $κ(y)_{\text{median}}>0.001$, the railway is curved and a warning message is displayed
